...
# ----- 코드 실행 ------
# members.append(Member("이상해씨", "그린", "Bulbasaur"))
# members.append(Member("파이리", "레드", "Charmander"))
# members.append(Member("꼬부기", "블루", "Squirtle"))
# for i in members:
#     i.display()
#     posts.append(Post("title1", "python1", i.username))
#     posts.append(Post("title2", "python2", i.username))
#     posts.append(Post("title3", "python3", i.username))
# for i in posts:
#     i.display()
# 기본 코드
